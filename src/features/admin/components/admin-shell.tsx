...
const navigation: NavigationItem[] = [
  ...
  { label: "Digital Audits", href: "/admin/digital-audits", icon: ClipboardCheck },
  { label: "Idea Gates", href: "/admin/idea-gates", icon: Lightbulb },
  ...
  { label: "Course publishing", href: "/admin/learn", icon: GraduationCap },
  { label: "Security", href: "/admin/security", icon: ShieldCheck, employeeVisible: true },
  { label: "People & access", href: "/admin/people", icon: UserCog },
...
const pageMeta = [
  ...
  ["/admin/digital-audits", "Digital Audits", "Manage completed and incomplete digital readiness assessments."],
  ["/admin/idea-gates", "Idea Execution Gates", "Assessed ideas, their verdicts and the leads behind them."],
  ...
  ["/admin/learn", "Course publishing", "Create, validate, preview, and publish Bespoke Learn courses."],
  ["/admin/security", "Admin security", "Authenticator handover, emergency recovery, sessions, and security activity."],
  ["/admin/people", "People and access", "Named identities, employee enrollment, and trusted sessions."],
